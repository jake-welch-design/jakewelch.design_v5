export default [
  {
    ...
    type: 'Archive',
    description:
      'The Restroom Archive is a years long on-going case study which aims to document and celebrate the humorous, chaotic, and often scary nature of the public restroom. The archive currently consists of 49 restrooms scanned over the course of 2 years using Polycam. The site was built using Three.js and Vue 3.',
    ...
    images: [
      {
        ...
        alt: 'Example image',
        caption: 'Design chosen for the book insert',
      },
      {
        src: require('@/assets/images/fabricated-landscapes/fl-01.png'),
        alt: 'Example image',
        caption: ' ',
      },
      {
        src: require('@/assets/images/fabricated-landscapes/fl-02.png'),
        alt: 'Example image',
        caption: ' ',
      },
      {
        src: require('@/assets/images/fabricated-landscapes/fl-04.png'),
        alt: 'Example image',
        caption: ' ',
      },
      {
        src: require('@/assets/images/fabricated-landscapes/fl-05.png'),
        alt: 'Example image',
        caption: ' ',
      },
    ],
  },
  {
    ...
    iframe: 'https://www.youtube.com/embed/dzHKuujppuo?si=uQMvAcHkGF5uGu7z',
    images: [
      {
        src: require('@/assets/images/glitch-type-generator/export-2.png'),
        alt: 'Example image',
        caption: ' ',
      },
      {
        src: require('@/assets/images/glitch-type-generator/export-3.png'),
        alt: 'Example image',
        caption: ' ',
      },
      {
        src: require('@/assets/images/glitch-type-generator/export-4.png'),
        alt: 'Example image',
        caption: ' ',
      },
    ],
